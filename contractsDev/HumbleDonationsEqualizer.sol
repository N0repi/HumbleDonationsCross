...
// // Interface for Equalizer Router
// interface IRouter {
//     struct Route {
//         address from;
//         address to;
...
// contract HumbleDonationsEqualizer is IHumbleDonations,
...
//     EQUALIZER_ROUTER and respected functions are a weakness of this contract.
...
//     // -----CONSTANTS-----
//     // address private constant EQUALIZER_ROUTER = (0xf08413857AF2CFBB6edb69A92475cC27EA51453b);
//     // /// @custom:oz-upgrades-unsafe-allow state-variable-immutable
//     // IRouter public immutable equalizerRouter = IRouter(EQUALIZER_ROUTER);
//     // -----CONSTANTS-----
...
//         upgradeCount = 0;
//         equalizerRouterAddress = 0xf08413857AF2CFBB6edb69A92475cC27EA51453b; // Sonic testnet address
//         equalizerRouter = IRouter(equalizerRouterAddress); // Instantiate the router interface
//     }
...
//     address public equalizerRouterAddress;
//     IRouter public equalizerRouter;
...
//         equalizerRouterAddress = newRouter;
//         equalizerRouter = IRouter(equalizerRouterAddress);
//     }
//     // Set HDT
...
//         // Approve the Equalizer Router to spend `tokenIn`
//         TransferHelper.safeApprove(tokenIn, address(equalizerRouter), amountIn);


//         // Execute the swap from `tokenIn` to `WETH`
//         uint[] memory amounts = equalizerRouter.swapExactTokensForTokensSimple(
//             amountIn,
//             slippageWETH,
//             tokenIn,
//             WETH,
...
//         // Distribute funds after swap (50% to recipient2, 25% to recipient1, and remaining for next swap)
//         uint256 halfWETH = amountOut / 2;
//         uint256 oneQuarterWETH = amountOut / 4;

//         IERC20(WETH).safeTransfer(recipient2, halfWETH);
//         IERC20(WETH).safeTransfer(recipient1, oneQuarterWETH);

//         // Approve the router to spend the remaining WETH to swap to HDT
//         TransferHelper.safeApprove(WETH, address(equalizerRouter), oneQuarterWETH);


//         // Perform the swap from WETH to HDT
//         amounts = equalizerRouter.swapExactTokensForTokensSimple(
//             oneQuarterWETH,
//             slippageHDT,
//             WETH,
//             HDT,
...
//         uint256 amountOutHDT = amounts[amounts.length - 1];
...
//                 swapExactInputSingleETH(taxAmount, slippageHDT, false);
